...
<WebServiceRequestEntity>
   ...
   <name>OBJ.017.04.02 Get Reference Number List Options</name>
   <tag></tag>
   <elementGuidId>285324ea-8b25-4836-b7a7-75f98930fdb3</elementGuidId>
   ...
   <restUrl>https://dev-api-sales.asdf.id/v1/admin/reference-number/options?documentType=true&amp;customer=true&amp;accountManager=true</restUrl>
