...
<WebServiceRequestEntity>
   ...
   <name>OBJ.009.21 Get Partner Contact Filter Options</name>
   <tag></tag>
   <elementGuidId>0a84ba6e-2b8f-46c4-a528-ac2d183e541d</elementGuidId>
   ...
   <restUrl>${customer_partner}${endpoint}?field=partner</restUrl>
   ...
   <variables>
      <defaultValue>'v1/contacts/partners/filters'</defaultValue>
      <description></description>
