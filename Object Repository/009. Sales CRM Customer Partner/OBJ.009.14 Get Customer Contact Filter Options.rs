...
<WebServiceRequestEntity>
   ...
   <name>OBJ.009.14 Get Customer Contact Filter Options</name>
   <tag></tag>
   <elementGuidId>23343653-5ddd-4b90-8b16-6a18541b3303</elementGuidId>
   ...
   <restUrl>${customer_partner}${endpoint}?field=customer</restUrl>
   ...
   <variables>
      <defaultValue>'v1/contacts/customers/filters/'</defaultValue>
      <description></description>
