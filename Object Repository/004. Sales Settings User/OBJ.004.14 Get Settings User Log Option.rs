...
<WebServiceRequestEntity>
   ...
   <name>OBJ.004.14 Get Settings User Log Option</name>
   <tag></tag>
   <elementGuidId>de5a9993-2891-414e-b438-4525b9e63d9d</elementGuidId>
   ...
   <restUrl>${settings_user}${endpoint}?actionOptions=true&amp;objectOptions=true</restUrl>
   ...
   <variables>
      <defaultValue>'v1/settings/user-logs/670f63c07de80158e14293a8/options'</defaultValue>
      <description></description>
