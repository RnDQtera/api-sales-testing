...
<WebServiceRequestEntity>
   ...
   <name>OBJ.004.04 Get Settings User Option</name>
   <tag></tag>
   <elementGuidId>e5a1cde7-7a20-4ffa-9aec-e139af4238c6</elementGuidId>
   ...
   <restUrl>${settings_user}${endpoint}?fullNameOptions=true&amp;userCodeOptions=true&amp;partnerOptions=true&amp;positionOptions=true&amp;roleOptions=true</restUrl>
   ...
   <variables>
      <defaultValue>'v1/settings/users/options'</defaultValue>
      <description></description>
