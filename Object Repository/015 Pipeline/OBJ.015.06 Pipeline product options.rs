...
<WebServiceRequestEntity>
   ...
   <name>OBJ.015.06 Pipeline product options</name>
   <tag></tag>
   <elementGuidId>d55ec021-15d0-4187-b1f4-53d580afa1fe</elementGuidId>
   ...
   <restUrl>${pipeline}${endpoint}?brandOptions=true&amp;productOptions=true&amp;skuOptions=true&amp;purchaseTypeOptions=true&amp;doProductOptions=true&amp;processedOptions=true&amp;receivedOptions=true</restUrl>
   ...
   <variables>
      <defaultValue>'/pipeline/672af875bac8fcd0abec2443/detail/products/options'</defaultValue>
      <description></description>
