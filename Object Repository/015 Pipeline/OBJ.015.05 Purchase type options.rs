...
<WebServiceRequestEntity>
   ...
   <name>OBJ.015.05 Purchase type options</name>
   <tag></tag>
   <elementGuidId>6139622c-c8f3-4443-9033-234efad774fd</elementGuidId>
   ...
   <restUrl>${pipeline}${endpoint}?productId=6721bfeba8a17fbc05abe894</restUrl>
   ...
   <variables>
      <defaultValue>'/pipeline/purchase-type/options'</defaultValue>
      <description></description>
