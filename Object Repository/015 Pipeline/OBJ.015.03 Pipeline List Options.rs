...
<WebServiceRequestEntity>
   ...
   <name>OBJ.015.03 Pipeline List Options</name>
   <tag></tag>
   <elementGuidId>37be01d8-d58a-4cb3-8207-cc5f15e7af87</elementGuidId>
   ...
   <restUrl>${pipeline}${endpoint}?type=sedang-berjalan&amp;accountManagerOptions=true&amp;customerOptions=true&amp;statusOptions=true&amp;productOptions=true&amp;skuOptions=true&amp;purchaseTypeOptions=true&amp;nextActionOptions=true</restUrl>
   ...
   <variables>
      <defaultValue>'/pipeline/options'</defaultValue>
      <description></description>
